...
def export(
    ...
    **kwargs,
    ...
    origninal_signature = inspect.signature(call_to_inspect)
    ...
    if (shape_env := getattr(fake_mode, "shape_env", None)) is not None:
        ...
        msg = dim_constraints.prettify_results(origninal_signature)
    ...
    def argument_names(f: Callable[..., Any], *args, **kwargs) -> List[str]:
        fullargspec = signature_to_fullargspec(origninal_signature)
